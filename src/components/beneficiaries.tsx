...
const beneficiariesData: Beneficiary[] = [
  ...
  },
  {
    ...
    description: "« ENTREPRENEURS EPANOUIS » est un programme d'accompagnement en stratégie d'acquisition de clients à l'endroit des coachs et consultants du domaine des relations humaines (coachs de vie, psychologues,...) grâce au marketing digital.",
    imageUrl: "/b-3.png",
  ...
  },
  {
    ...
    projectType: "Site Vitrine Professionnel ",
    description: "« AUTO ÉCOLE AGRÉÉE LA CAPITALE » est un projet visant à former des conducteurs responsables et compétents, capables de circuler en toute sécurité et conformément à la réglementation routière afin de leur permettre d’obtenir un permis de conduire",
    imageUrl: "/b-6.jpg",
    linkedinUrl:
